#pragma once
#include <Arduino.h>
// Arduino_GFX includes VERWIJDERD - gebruiken nu LovyanGFX!
#include "fonts.h"
#include "config.h"

// Forward declarations voor LovyanGFX wrappers
class DisplayWrapper;
class CanvasWrapper;

// Externe GFX objecten (nu LovyanGFX wrappers)
extern DisplayWrapper  *gfx;
extern CanvasWrapper   *cv;

// Pinout/rotatiewaarden worden in display.cpp gezet
// (Niet meer nodig voor LovyanGFX maar houden voor compatibiliteit)
extern const int LCD_BL;
