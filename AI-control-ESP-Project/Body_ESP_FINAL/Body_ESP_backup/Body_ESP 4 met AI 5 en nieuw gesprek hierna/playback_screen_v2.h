...
// Scherm dimensies - LANDSCAPE (480x320)
...
// Grafieken area (rechts) - voor HR, TEMP, GSR, LEVEL
#define PB_GRAPH_X          (PB_LEVEL_PANEL_W + 5)
#define PB_GRAPH_W          (PB_SCREEN_W - PB_GRAPH_X - 5)
#define PB_GRAPH_Y          PB_TITLE_H
#define PB_GRAPH_H          185

// Afspeelbalk (onder level paneel en grafieken)
...
#define PB_BUTTON_X         5  // Voor touch handling
...
public:
  ...
  void drawSensorGraphs();      // 🔥 HR, TEMP, GSR grafieken rechts
