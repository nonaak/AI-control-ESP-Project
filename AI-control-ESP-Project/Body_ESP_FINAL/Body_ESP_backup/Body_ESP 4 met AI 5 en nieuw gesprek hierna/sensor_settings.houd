...
struct SensorConfig {
  ...
  // ADS1115 Auto-kalibratie (nieuw)
  float ads_gsrBaseline = 2048.0f;   // ADS1115 GSR baseline
  int ads_pulseBaseline = 2048;      // ADS1115 Pulse baseline
  float ads_ntcOffset = 0.0f;        // ADS1115 NTC offset
...
void applySensorConfig();             // Pas config toe op ADS1115
