...
// Model slot info structuur (NVS-specifiek)
// Let op: verschilt van MLModelInfo in ml_training_view.h!
struct NVSModelSlotInfo {
...
// Model info
bool nvsSettings_getModelInfo(uint8_t slot, NVSModelSlotInfo* info);
