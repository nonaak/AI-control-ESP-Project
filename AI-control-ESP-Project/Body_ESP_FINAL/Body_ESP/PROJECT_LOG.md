...
moet nog iest maken dat ik kan zien in playback welke stress level is toegekent op wel moment, die ik heb toegekent en die AI heeft toegekent.
met een optie om dat nog te veranderen.

---

voor Claude:
- bezig geweest om het afspeel menu met de stress level popup.
  met pauze en dat de popup terug geen grafieken
  zonder pauze de popup wel grafieken

 ✅ Watchdog timer - KLAAR!
📡 ESP-NOW retry queue - Geen data loss (20 min)
💾 SD card buffer - klaar
