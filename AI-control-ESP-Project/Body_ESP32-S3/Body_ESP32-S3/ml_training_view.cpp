  ...
  if (modelCount == 0) {
    ...
    for (int i = 0; i < modelCount && y < (SCR_H - 80); i++) {
      ...
      if (info.isActive) {
        ...
        g->drawCircle(18, y + 8, 3, (i == selectedModelIndex) ? TFT_BLACK : COL_TX);
      }
