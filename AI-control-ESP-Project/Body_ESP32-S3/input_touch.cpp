...
static const uint16_t TAP_COOLDOWN_MS=400;   // Cooldown tussen touch events
...
void inputTouchBegin(TFT_eSPI* gfx){
  ...
  touch.begin(240, 320);
  // T-HMI factory kalibratie data (aangepast voor Y-offset correctie)
  touch.setCal(285, 1788, 280, 1846, 240, 320); // Y-waarden aangepast
  touch.setRotation(3);  // Factory gebruikt rotatie 3
  Serial.println("[TOUCH] T-HMI XPT2046 touch system geïnitialiseerd met aangepaste kalibratie");
#endif
}
